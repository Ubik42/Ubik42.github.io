...
`,Vp={fathom:{zh:oE,en:lE},"house-of-vampires":{zh:cE,en:uE},"through-other-eyes":{zh:mE,en:hE},"retro-arcade":{zh:dE,en:fE},"digital-twin":{zh:sE,en:rE}},gE=[{id:"noemancer",title:"Noemancer",category:"engine-games",categoryLabel:{zh:"自研游戏引擎",en:"Custom game engine"},summary:{zh:"C++20 游戏引擎与编辑器，覆盖渲染、物理、动画、C# 脚本、资产烘焙和 Agent 工具层。",en:"A C++20 engine and editor spanning rendering, physics, animation, C# scripting, asset cooking, and agent tools."},cover:"/media/repositories/noemancer.webp",tags:["C++20","D3D12 / Vulkan","C#","MCP"],repositoryUrl:"https://github.com/Ubik42/Noemancer",story:{zh:`# Noemancer
...
The project is pre-alpha and currently verified end to end on Windows x64. SSR, SSGI, hardware ray tracing, dynamic atmosphere, and a stable plug-in SDK are not presented as finished features.`},images:[{src:"/media/repositories/noemancer.webp",alt:{zh:"Noemancer 编辑器实机界面",en:"Noemancer editor running in-engine"}}]},{id:"art-pipeline-skill",title:"Art Pipeline Skill",category:"pipeline",categoryLabel:{zh:"工具与资产管线审计 Skill",en:"Tool and asset pipeline audit skill"},summary:{zh:"从旧 AIToolTA 体系中收口出的轻量 Skill：登记真实工具能力，校验版本、只读边界与执行证据。",en:"A focused skill extracted from the retired AIToolTA suite to validate registered tools, versions, read-only boundaries, and execution evidence."},cover:"/media/repositories/production-tools/art-pipeline-overview.png",tags:["Skill","Maya / Unreal","JSON Schema","只读审计"],repositoryUrl:"https://github.com/Ubik42/art-pipeline-skill",story:{zh:`# Art Pipeline Skill
...
The Tauri 2 and React desktop application connects to Rez through a Python service, exposes launch diagnostics, and ships a Windows installer plus a documented CLI protocol.`},images:[{src:"/media/repositories/rez-studio.png",alt:{zh:"Rez Studio 项目软件库",en:"Rez Studio project application library"}}]},{id:"mayascope",title:"MayaScope",category:"pipeline",categoryLabel:{zh:"Maya 场景调查与运行时诊断",en:"Maya scene and runtime observatory"},summary:{zh:"把大型 Maya 场景组织成可查询快照、依赖图、运行时足迹和回归证据，用于定位根因而非只列错误。",en:"Turns Maya scenes into queryable snapshots, dependency graphs, runtime footprints, and regression evidence for root-cause diagnosis."},cover:"/media/repositories/production-tools/mayascope-host.png",tags:["Maya 2025","Scene Graph","Profiler","Regression"],repositoryUrl:"https://github.com/Ubik42/MayaIndieTool",story:{zh:`# MayaScope
