...
Current compatibility evidence is limited to Windows x64 and Blender 5.2.0. Automatic repair is limited to mesh naming and object hierarchy.`},images:[{src:"/media/repositories/production-tools/blender-toolsmith-agent.png",alt:{zh:"Blender 5.2 中运行的中文场景交付检查面板",en:"Chinese Scene Delivery Check panel running in Blender 5.2"}}]},{id:"advanced-skeleton-python-refactor",title:"AdvancedSkeleton Python 架构重构",category:"pipeline",categoryLabel:{zh:"Maya 角色绑定架构与跨 DCC 迁移研究",en:"Maya rigging architecture and cross-DCC migration research"},summary:{zh:"v0.96.0 将角色绑定拆分为 Python Core、用例层与 Maya 适配器；Fit、Body、FK/IK、蒙皮及跨脊柱段数替换已有 Maya 2024 后台验证，392 项 Python 回归通过。",en:"Version 0.96.0 separates rigging into a Python core, use cases, and a Maya adapter. Fit, Body, FK/IK, skinning, and cross-segment spine replacement have Maya 2024 standalone coverage, with 392 Python regression tests."},cover:"/media/repositories/production-tools/advanced-skeleton-python-refactor.svg",tags:["v0.96.0","Maya 2024","Python","392 Tests"],repositoryUrl:"https://github.com/Ubik42/advanced-skeleton-python-refactor",story:{zh:`# AdvancedSkeleton Python 架构重构
