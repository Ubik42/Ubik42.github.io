...
角色存活、移动、到达率、请求失败、最长等待、近景动画质量、阴影保留和连接数都会参与结果判断。质量条件不成立的候选不会被写成成功优化。`,en:`# Multi-Character Performance Optimization
