...
Current compatibility evidence is limited to Windows x64 and Blender 5.2.0. Automatic repair is limited to mesh naming and object hierarchy.`},images:[{src:"/media/repositories/production-tools/blender-toolsmith-agent.png",alt:{zh:"Blender 5.2 中运行的中文场景交付检查面板",en:"Chinese Scene Delivery Check panel running in Blender 5.2"}}]},{id:"advanced-skeleton-python-refactor",title:"AdvancedSkeleton Python 架构重构",category:"pipeline",categoryLabel:{zh:"Maya 角色绑定架构与跨 DCC 迁移研究",en:"Maya rigging architecture and cross-DCC migration research"},summary:{zh:"v0.95.0 采用 Maya-first、Blender-second 路线，将授权环境中的单体 MEL 行为拆分为纯 Python Core、用例层与宿主适配器；当前完成 90 个 Maya 切片和 272 项回归测试。",en:"Version 0.95.0 follows a Maya-first, Blender-second path, separating licensed MEL behavior into a pure-Python core, application use cases, and host adapters; 90 Maya slices and 272 regression tests are complete."},cover:"/media/repositories/production-tools/advanced-skeleton-python-refactor.svg",tags:["v0.95.0","Maya 2024","90 Maya Slices","272 Tests"],story:{zh:`# AdvancedSkeleton Python 架构重构
...
//# sourceMappingURL=index-C9O0CPnm-portfolio-refresh.js.map
