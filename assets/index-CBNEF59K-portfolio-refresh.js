...
\r
A compact industrial digital-twin prototype completed during my internship at Shanghai Ruwei Electric Power. Built on the open-source icegl / TresJS project, it turns a general Web 3D framework into a focused business page for inspecting equipment, navigating scenes, and tuning mechanical parameters.\r
\r
![Industrial digital twin capture](/media/projects/digital-twin.png)\r
\r
## From industrial assets to an interactive page\r
\r
...
\r
The upstream framework supplies general city, globe, and data-visualization modules. My internship deliverable covers the industrial asset, mechanical control, business-page, and interaction-debugging layer.\r
`,lw=`# Industrial Digital Twin\r
\r
这是我在上海如为电力实习期间完成的小型工业数字孪生原型，用浏览器承载设备模型、场景查看与机械参数调试。项目基于开源 icegl / TresJS 工程继续开发，我负责把通用 Web 3D 框架整理成可直接演示工业设备的业务页面。\r
\r
...
## 技术结构\r
\r
前端使用 Vue 3、TresJS 与 Three.js 组织 Web 3D 场景。模型载入后通过 TransformControls 和参数面板改变位置、旋转与关节状态，使工业资产无需安装专用客户端即可在浏览器中检查和演示。这个小项目也让我把实时引擎中的场景层级、Transform 与交互状态经验迁移到 Web 3D 技术栈。\r
\r
## 项目范围\r
\r
底层框架提供城市、地球与数据可视化等通用模块；这次实习原型聚焦工业设备场景，我完成的是工业资产接入、机械控制、业务页面和交互调试这一整段可交付链路。\r
`,uw=`# Fathom\r
\r
...
`,hw=`# Retro 3D Arcade Prototype\r
\r
...
`,mw=`# Retro 3D Arcade Prototype\r
\r
