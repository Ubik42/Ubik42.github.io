...
`,Vp={fathom:{zh:cw,en:uw},"house-of-vampires":{zh:dw,en:fw},"through-other-eyes":{zh:pw,en:gw},"retro-arcade":{zh:mw,en:hw},"digital-twin":{zh:lw,en:ow}},yw=[{id:"resonance-forge",title:"共振铸造台：UE × Wwise 物理材质声源工具",category:"engine-games",categoryLabel:{zh:"Unreal 客户端音频工具",en:"Unreal client audio tooling"},summary:{zh:"把钢、木、玻璃的物理碰撞转换为可演奏的模态共振，并同步驱动 Wwise Event、三项 RTPC 与 MIDI 表演输入。",en:"Turns physical impacts on steel, wood, and glass into playable modal resonance while driving a Wwise Event, three RTPCs, and MIDI input."},cover:"/media/repositories/resonance-forge/overview.png",tags:["Unreal 5.8","Wwise","C++ / Slate","MIDI / 物理音频"],repositoryUrl:"https://github.com/Ubik42/resonance-forge",story:{zh:`# 共振铸造台 Resonance Forge
...
演示地图、三种 1024×1024 材质贴图和三档撞击 WAV 都由确定性脚本生成。后台复检会重新加载磁盘地图，确认三颗 18 kg 落球的 Movable、重力、碰撞和物理模拟状态。当前 Windows Editor 构建与 4 项自动化测试已经通过；Wwise SDK 与官方 Unreal Integration 需要使用者自行通过 Audiokinetic Launcher 安装，不随公开仓库重新分发。`,en:`# Resonance Forge
...
The repository includes a Chinese Slate editor panel, the physical instrument actor, native UE synthesis, Wwise integration, deterministic demo textures and audio, a generated showcase level, and backend verification. Wwise SDK and the official Unreal Integration are intentionally not redistributed.`},images:[{src:"/media/repositories/resonance-forge/overview.png",alt:{zh:"Unreal Engine 中的共振铸造台实验场景与中文插件工作台",en:"Resonance Forge scene and Chinese editor workbench in Unreal Engine"}}]},{id:"noemancer",title:"最最 AI 友好的高性能引擎",category:"engine-games",categoryLabel:{zh:"自研游戏引擎",en:"Custom game engine"},summary:{zh:"从原生 Editor、C# Gameplay、资产 Cook 到 D3D12/Vulkan 商业 Raster 和独立 Player 的 C++20 游戏引擎。",en:"A C++20 game engine spanning a native editor, C# gameplay, asset cooking, D3D12/Vulkan commercial raster rendering, and standalone players."},cover:"/media/repositories/major-updates/noemancer-sponza-atrium.webp",tags:["C++20","D3D12 / Vulkan","C#","MCP"],repositoryUrl:"https://github.com/Ubik42/Noemancer",story:{zh:`# 最最 AI 友好的高性能引擎
