...
Motion references: [indoor dance / Tencent MimicMotion](https://github.com/Tencent/MimicMotion/blob/main/assets/example_data/videos/pose1.mp4) and [frontal martial arts / olia danilevich, Pexels](https://www.pexels.com/video/girl-doing-taekwondo-6005332/). MimicMotion is a reference-video source only; its generation model is not used.`}},CA={id:"als-director",title:"动作导演 · 自然语言驱动角色表演",category:"ai-agent",categoryLabel:{zh:"运行时 AI 与技术动画",en:"Runtime AI and technical animation"},summary:{zh:"将“抱着箱子走过去，途中看向门口”拆成可验证的动作计划，在 Unreal 中控制步态、姿态、移动与注视；支持途中改口、连续动作和急停。",en:"Natural-language direction becomes validated movement, gait, overlay, stance, and gaze plans in Unreal, with live revisions, queued actions, and emergency stops."},cover:"/media/repositories/als-director/hero.webp",tags:["Unreal Engine 5.8","C++","GPT / Codex","ALS-Refactored","运行时动画"],story:{zh:`# 动作导演
...
源码包不含 Unreal Engine 或 ALS 插件资产；安装 UE 5.8 后运行依赖脚本，从固定上游提交获取 ALS 并构建。`,en:`# Motion Director
...
The source archive excludes Unreal Engine and ALS dependency assets. Setup retrieves the pinned upstream dependency and builds against a locally installed UE 5.8.`}},EA=[CA,AA,...TA,{id:"frostbound-gate",title:"霜隙之门 · Frostbound Gate",category:"general-ta",categoryLabel:{zh:"Unity 场景特效",en:"Unity scene VFX"},summary:{zh:"雪地遗迹中的冰晶传送门。旅人靠近时凝结，穿越后传送，远离时碎裂消散；包含昼夜变化、分层冰材质和程序生成资产。",en:"An ice-crystal portal in snowy ruins: approach to form it, cross to teleport, and retreat to dissolve it. Includes a day–night cycle, layered ice shading, and procedural assets."},cover:"/media/repositories/frostbound-gate/hero.webp",tags:["Unity 6","URP","Shader","程序化建模","场景交互"],repositoryUrl:"https://github.com/Ubik42/FrostboundGate",story:{zh:`# 霜隙之门
