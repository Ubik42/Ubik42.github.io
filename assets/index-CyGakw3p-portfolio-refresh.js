...
项目仍处于 Pre-alpha，只完整验证 Windows x64。稳定插件 SDK、跨平台发行、生产网络、签名安装器、硬件光追画面、RTGI 与 VSM 仍未完成；README 和页面只展示已经进入真实画面、完整运行链路或结构化证据的能力。`,en:`# Noemancer
