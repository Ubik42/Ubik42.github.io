...
`,jg={fathom:{zh:mA,en:fA},"house-of-vampires":{zh:gA,en:pA},"through-other-eyes":{zh:SA,en:bA},"retro-arcade":{zh:vA,en:yA},"digital-twin":{zh:hA,en:dA}},wA=[{slug:"toon",title:"UE Toon 卡通光照与描边",label:"引擎渲染 · 风格化着色",summary:"以三段明暗色块和反向壳描边表现雕塑轮廓，研究材质级卡通光照与环境之间的视觉关系。",summaryEn:"Material-level toon lighting with three shading bands and inverted-hull outlines on a sculptural subject.",tags:["UE 5.8","HLSL","Toon Shading","轮廓描边"],map:"01_Toon",source:"BV11Sej6kEGi",detail:`## 明暗色块与轮廓
...
`,HA=`# Unreal Engine Stylized World\r
\r
