...
`,_A=`# Unreal Engine Stylized World\r
\r
...
\r
![image.png](image%2043.png)\r
`,qA={"unreal-stylized-world":{zh:PA,en:_A},"maya-plugin":{zh:BA,en:VA},"stylized-road-material":{zh:LA,en:kA},"rigging-animation":{zh:OA,en:jA},"unity-sdf-shader":{zh:GA,en:NA},"houdini-lightning":{zh:xA,en:MA},"houdini-cluster":{zh:UA,en:zA},"unreal-vfx":{zh:IA,en:HA},"houdini-tower":{zh:RA,en:DA}},Uv=/^!\[(.*?)\]\((.*?)\)$/,Mv=/^@\[video(?::\s*(.*?))?\]\((.*?)\)$/,xv=/^(#{1,6})\s+(.+)$/,Ru=/^\s*-\s+(.+)$/,Vu=/^\s*\d+\.\s+(.+)$/,XA=/(`[^`]+`|\*\*[^*]+\*\*|\[[^\]]+\]\([^)]+\)|https?:\/\/[^\s)]+)/g;function no(a){return a.replace(/^\s*>\s?/,"").trimEnd()}function FA(a){const r=no(a).trim();return!r||r==="<aside>"||r==="</aside>"||Uv.test(r)||Mv.test(r)||xv.test(r)||Ru.test(r)||Vu.test(r)}function YA(a){const r=a.replace(/\r\n/g,`
`).split(`
`),o=[];for(let l=0;l<r.length;){const u=no(r[l]).trim();if(!u||u==="<aside>"||u==="</aside>"){l+=1;continue}const f=u.match(Uv);if(f){o.push({type:"image",alt:f[1],src:f[2]}),l+=1;continue}const h=u.match(Mv);if(h){o.push({type:"video",caption:h[1]??"",src:h[2]}),l+=1;continue}const g=u.match(xv);if(g){o.push({type:"heading",level:g[1].length,text:g[2].replace(/^\*\*|\*\*$/g,"")}),l+=1;continue}const y=u.match(Ru),m=u.match(Vu);if(y||m){const b=!!m,S=[];for(;l<r.length;){const M=no(r[l]).trim().match(b?Vu:Ru);if(!M)break;S.push(M[1]),l+=1}o.push({type:"list",ordered:b,items:S});continue}const v=[u];for(l+=1;l<r.length&&!FA(r[l]);)v.push(no(r[l]).trim()),l+=1;o.push({type:"paragraph",text:v.join(" ")})}return o}function KA(a){let r=a;for(let u=0;u<2;u+=1)try{r=decodeURIComponent(r)}catch{break}if(r==="image.png")return"/media/notion/image-000.webp";if(r==="texture.png")return"/media/notion/texture.webp";if(r==="PixPin_2024-11-13_18-17-55.gif")return"/media/notion/vfx-fluctuation.gif";const o=r.match(/^image (\d+)\.png$/);if(o)return`/media/notion/image-${o[1]}.webp`;const l=r.match(/^图片(\d+)\.png$/);return l?`/media/notion/cover-${l[1]}.webp`:a}function su(a){return a.split(XA).filter(Boolean).map((r,o)=>{if(r.startsWith("`")&&r.endsWith("`"))return D.jsx("code",{children:r.slice(1,-1)},o);if(r.startsWith("**")&&r.endsWith("**"))return D.jsx("strong",{children:r.slice(2,-2)},o);const l=r.match(/^\[([^\]]+)\]\(([^)]+)\)$/);return l?D.jsx("a",{href:l[2],target:"_blank",rel:"noreferrer",children:l[1]},o):/^https?:\/\//.test(r)?D.jsx("a",{href:r,target:"_blank",rel:"noreferrer",children:r},o):r})}function od({markdown:a,title:r}){const o=YA(a),l=o.findIndex(u=>u.type==="heading"&&u.level===1);return D.jsx("div",{className:"notion-story",children:o.map((u,f)=>{if(f===l)return null;if(u.type==="image")return D.jsx("figure",{children:D.jsx("img",{src:KA(u.src),alt:u.alt||r,loading:"lazy"})},`${u.src}-${f}`);if(u.type==="video")return D.jsxs("figure",{className:"story-video",children:[D.jsx("video",{src:u.src,controls:!0,preload:"metadata",playsInline:!0}),u.caption&&D.jsx("figcaption",{children:u.caption})]},`${u.src}-${f}`);if(u.type==="heading"){const h=u.level<=2?"h3":"h4";return D.jsx(h,{children:su(u.text)},f)}if(u.type==="list"){const h=u.ordered?"ol":"ul";return D.jsx(h,{children:u.items.map((g,y)=>D.jsx("li",{children:su(g)},`${g}-${y}`))},f)}return D.jsx("p",{children:su(u.text)},f)})})}const QA=[{id:"moss",name:"Moss Courier",zh:"外套角色",en:"Stylized courier"},{id:"aster",name:"Aster Runner",zh:"运动服角色",en:"Athletic character"},{id:"cobalt",name:"Cobalt Sentinel",zh:"人形机器人",en:"Humanoid robot"}],ZA=[{id:"dance",zh:"首段舞蹈 · 12 秒",en:"Indoor dance · 12 s"},{id:"combat",zh:"正面武术 · 7 秒",en:"Frontal martial arts · 7 s"}],Og="/media/repositories/animation-aigc-lab";function JA({locale:a}){return D.jsx("section",{className:"animation-aigc-showcase","aria-label":a==="zh"?"三个角色、两种动作":"Three characters, two motions",children:QA.map(r=>D.jsxs("section",{children:[D.jsxs("h3",{children:[r.name," ",D.jsxs("span",{children:["· ",r[a]]})]}),D.jsx("div",{className:"animation-aigc-pair",children:ZA.map(o=>D.jsxs("figure",{children:[D.jsx("video",{controls:!0,playsInline:!0,preload:"none",poster:`${Og}/${r.id}-${o.id}.webp`,src:`${Og}/${r.id}-${o.id}.mp4`,"aria-label":`${r.name} · ${o[a]}`}),D.jsx("figcaption",{children:o[a]})]},o.id))})]},r.id))})}const WA=[{id:"all",zh:"全部作品",en:"All work"},{id:"pipeline",zh:"工具管线",en:"Tool pipelines"},{id:"engine-games",zh:"引擎与游戏",en:"Engines & games"},{id:"ai-agent",zh:"AIGC & Agent",en:"AIGC & Agent"},{id:"general-ta",zh:"通用技术美术技能",en:"General technical art"},{id:"other-tools",zh:"部分其他工具",en:"Selected other tools"}],kg=new Map(["rez-studio-launcher","advanced-skeleton-python-refactor","art-pipeline-skill","maya-plugin","internship-art-pipeline","maya-garment-preparation","mayascope","mayacraft","asset-delivery-organizer","maya-scene-checker","blender-toolsmith-agent"].map((a,r)=>[a,r])),Lg=new Map(["siggraph-physics-lab","noemancer","noemancer-software-rasterizer","aita-toon","aita-wind","aita-schooling","aita-cloth","aita-cosmos","aita-fog","aita-fracture","lyra-hero-arena","lyra-performance-lab","ue-performance-workbench","resonance-forge","unreal-asset-batch-auditor"].map((a,r)=>[a,r])),Ng=new Map(["animation-aigc-lab","artflow-agent","comfyui-production-nodes"].map((a,r)=>[a,r])),Gg=new Map([["pipeline",0],["engine-games",1],["ai-agent",2],["general-ta",3],["other-tools",4]]);function $A(){const{locale:a}=fi(),r=Ev()??!1,[o,l]=J.useState("all"),[u,f]=J.useState(null),h=J.useRef(null),g=J.useMemo(()=>[...CA.map(E=>({kind:"repository",id:E.id,category:E.category,title:E.title,label:Nt(E.categoryLabel,a),summary:Nt(E.summary,a),cover:E.cover,tags:E.tags,value:E})),...EA.map(E=>({kind:"visual",id:E.id,category:E.portfolioCategory,title:Nt(E.title,a),label:Nt(E.category,a),summary:Nt(E.summary,a),cover:E.cover,tags:E.tools,value:E})),...uA.map(E=>({kind:"project",id:E.id,category:E.portfolioCategory,title:E.title,label:Yn(E.category,a),summary:Yn(E.summary,a),cover:E.images[0].src,tags:E.stack,value:E}))].map((E,M)=>({item:E,sourceIndex:M})).sort((E,M)=>{const L=(Gg.get(E.item.category)??Number.MAX_SAFE_INTEGER)-(Gg.get(M.item.category)??Number.MAX_SAFE_INTEGER);return L!==0?L:E.item.category==="pipeline"?(kg.get(E.item.id)??Number.MAX_SAFE_INTEGER)-(kg.get(M.item.id)??Number.MAX_SAFE_INTEGER):E.item.category==="engine-games"?(Lg.get(E.item.id)??Number.MAX_SAFE_INTEGER)-(Lg.get(M.item.id)??Number.MAX_SAFE_INTEGER):E.item.category==="ai-agent"?(Ng.get(E.item.id)??Number.MAX_SAFE_INTEGER)-(Ng.get(M.item.id)??Number.MAX_SAFE_INTEGER):E.sourceIndex-M.sourceIndex}).map(({item:E})=>E),[a]),y=o==="all"?g:g.filter(S=>S.category===o),m=(S,E="replace")=>{const M=new URL(window.location.href);S?M.searchParams.set("work",S):M.searchParams.delete("work"),window.history[E==="push"?"pushState":"replaceState"]({},"",`${M.pathname}${M.search}${M.hash}`)},v=S=>{m(S.id,"push"),f(S)},b=()=>{m(null),f(null)};return J.useEffect(()=>{const S=()=>{const E=new URLSearchParams(window.location.search).get("work");E===Sn.id?f({kind:"repository",id:Sn.id,category:Sn.category,title:Sn.title,label:Nt(Sn.categoryLabel,a),summary:Nt(Sn.summary,a),cover:Sn.cover,tags:Sn.tags,value:Sn}):f(E?g.find(M=>M.id===E)??null:null)};return S(),window.addEventListener("popstate",S),()=>window.removeEventListener("popstate",S)},[g,a]),J.useEffect(()=>{const S=h.current;if(S)return u?(S.open||S.showModal(),S.scrollTop=0,document.body.classList.add("has-project-dialog")):(S.open&&S.close(),document.body.classList.remove("has-project-dialog")),()=>document.body.classList.remove("has-project-dialog")},[u]),D.jsxs("section",{id:"portfolio",className:"portfolio-gallery","aria-labelledby":"portfolio-title",children:[D.jsxs("header",{className:"portfolio-gallery-header",children:[D.jsxs("div",{children:[D.jsx("h2",{id:"portfolio-title",children:a==="zh"?"作品":"Work"}),D.jsx("span",{children:String(g.length).padStart(2,"0")})]}),D.jsx("p",{children:a==="zh"?"完整图文、演示与源码链接集中收录于各项目详情。":"Full case studies, demos, and source links are collected in each project detail."})]}),D.jsx("div",{className:"portfolio-filters",role:"group","aria-label":a==="zh"?"筛选作品":"Filter work",children:WA.map(S=>D.jsx("button",{type:"button","data-filter":S.id,className:o===S.id?"is-active":"","aria-pressed":o===S.id,onClick:()=>l(S.id),children:a==="zh"?S.zh:S.en},S.id))}),D.jsx("div",{className:"portfolio-grid",children:y.map(S=>D.jsxs(zv.button,{type:"button",className:"portfolio-tile","data-category":S.category,onClick:()=>v(S),whileHover:r?void 0:{y:-4},transition:{duration:.18},children:[D.jsx("figure",{children:D.jsx("img",{src:S.cover,alt:"",loading:"eager"})}),D.jsxs("div",{className:"portfolio-tile-copy",children:[D.jsx("small",{children:S.label}),D.jsx("h3",{children:S.title}),D.jsx("p",{children:S.summary}),D.jsx("div",{children:S.tags.slice(0,4).map(E=>D.jsx("span",{children:E},E))})]})]},`${S.kind}-${S.id}`))}),D.jsx("dialog",{ref:h,className:`project-dialog unified-dialog ${u?.kind==="visual"?"visual-work-dialog":""}`,onCancel:S=>{S.preventDefault(),b()},onClose:b,onClick:S=>{S.target===S.currentTarget&&b()},children:u&&D.jsx(eC,{item:u,locale:a,close:b})})]})}function eC({item:a,locale:r,close:o}){const l=Ev()??!1;return D.jsxs(zv.article,{initial:l?!1:{opacity:0,y:14},animate:{opacity:1,y:0},transition:{duration:.2},children:[D.jsx("button",{className:"project-dialog-close",type:"button",onClick:o,"aria-label":r==="zh"?"关闭项目详情":"Close project details",children:"×"}),D.jsxs("div",{className:"project-dialog-heading","data-work-id":a.id,children:[D.jsxs("p",{children:[a.label," · ",a.tags.join(" · ")]}),D.jsx("h2",{children:a.title}),D.jsx("p",{children:a.summary})]}),a.kind==="repository"&&D.jsx(tC,{work:a.value,locale:r}),a.kind==="visual"&&D.jsx(nC,{work:a.value,locale:r}),a.kind==="project"&&D.jsx(aC,{project:a.value,locale:r})]},`${a.kind}-${a.id}`)}function tC({work:a,locale:r}){const o=a.images?.filter(u=>u.src!==a.cover)??[],l=a.id==="noemancer"||a.id==="artflow-agent"?"cover":"contain";return D.jsxs(D.Fragment,{children:[a.repositoryUrl&&D.jsxs("a",{className:"project-dialog-source",href:a.repositoryUrl,target:"_blank",rel:"noreferrer",children:[D.jsx("span",{children:r==="zh"?"查看 GitHub 仓库":"View GitHub repository"}),D.jsx("span",{"aria-hidden":"true",children:"↗"})]}),D.jsx(iC,{src:a.cover,alt:`${a.title} ${r==="zh"?"项目画面":"project view"}`,fit:l}),a.id==="animation-aigc-lab"&&D.jsx(JA,{locale:r}),D.jsx(od,{markdown:Nt(a.story,r),title:a.title}),o.length>0&&D.jsx(rC,{fit:"contain",images:o.map(u=>({src:u.src,alt:Nt(u.alt,r),caption:Nt(u.alt,r)}))})]})}function nC({work:a,locale:r}){return D.jsxs(D.Fragment,{children:[D.jsxs("a",{className:"project-dialog-source",href:a.artstationUrl,target:"_blank",rel:"noreferrer",children:[D.jsx("span",{children:r==="zh"?"查看原始 ArtStation 项目":"View the original ArtStation project"}),D.jsx("span",{"aria-hidden":"true",children:"↗"})]}),a.youtubeId&&D.jsx(Dv,{youtubeId:a.youtubeId,title:Nt(a.title,r)}),D.jsx(od,{markdown:qA[a.id][r],title:Nt(a.title,r)})]})}function aC({project:a,locale:r}){return D.jsxs(D.Fragment,{children:[a.link&&D.jsxs("a",{className:"project-dialog-source",href:a.link.href,target:"_blank",rel:"noreferrer",children:[D.jsx("span",{children:Yn(a.link.label,r)}),D.jsx("span",{"aria-hidden":"true",children:"↗"})]}),a.youtubeId&&D.jsx(Dv,{youtubeId:a.youtubeId,title:a.title}),jg[a.id]?D.jsx(od,{markdown:jg[a.id][r],title:a.title}):a.story&&D.jsxs("section",{className:"project-dialog-story",children:[D.jsx("h3",{children:Yn(a.story.title,r)}),D.jsx("p",{children:Yn(a.story.intro,r)}),D.jsx("h4",{children:r==="zh"?"玩法与特色":"Gameplay & Features"}),D.jsx("dl",{children:a.story.features.map(o=>D.jsxs("div",{children:[D.jsx("dt",{children:Yn(o.title,r)}),D.jsx("dd",{children:Yn(o.detail,r)})]},o.title.en))}),a.story.note&&D.jsx("p",{className:"project-dialog-note",children:Yn(a.story.note,r)})]})]})}function iC({src:a,alt:r,fit:o}){return D.jsx("figure",{className:`project-dialog-lead-media ${o==="contain"?"is-contain":""}`,children:D.jsx("img",{src:a,alt:r})})}function Dv({youtubeId:a,title:r}){return D.jsx("div",{className:"project-dialog-video",children:D.jsx("iframe",{src:`https://www.youtube-nocookie.com/embed/${a}?rel=0`,title:`${r} demo video`,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerPolicy:"strict-origin-when-cross-origin",allowFullScreen:!0})})}function rC({images:a,fit:r="cover"}){return D.jsx("div",{className:`project-dialog-gallery ${r==="contain"?"is-contain":""}`,children:a.map(o=>D.jsxs("figure",{children:[D.jsx("img",{src:o.src,alt:o.alt,style:{objectPosition:o.position},loading:"lazy"}),o.caption&&D.jsx("figcaption",{children:o.caption})]},o.src))})}function sC(){const{locale:a,copy:r}=fi();return D.jsxs("div",{className:"site","data-locale":a,children:[D.jsx("a",{className:"skip-link",href:"#main",children:a==="zh"?"跳到主要内容":"Skip to main content"}),D.jsx("span",{id:"top"}),D.jsx(f1,{}),D.jsxs("main",{id:"main",children:[D.jsx(m1,{}),D.jsx($A,{})]}),D.jsx(d1,{}),D.jsx("div",{className:"locale-status sr-only","aria-live":"polite",children:r.language.changed})]})}const oC={en:{meta:{title:"Lucas Shen | AI Tool-Pipeline TA & Engine Tools",description:"Games, DCC plug-ins, realtime graphics, engine tools, and AI-assisted art pipelines by Lucas Shen."},nav:{work:"Projects",practice:"Experience",links:"Links",aria:"Primary navigation"},language:{label:"Language",english:"English",changed:"Language changed to English."},hero:{role:"AI Tool-Pipeline TA & Engine Tool Development",primaryAction:"Selected projects"},personal:{intro:"My work spans games, DCC plug-ins, realtime graphics, engine tools, and AI-assisted art pipelines, with running builds, project captures, and implementation details.",storyAction:"About me",aboutTitle:"About me",aboutBody:["I’m Lucas, a technical artist from China. My path crosses industrial engineering, game development, realtime graphics, and production tools. That mix helps me move between an artist’s problem and the system behind it.","I enjoy reverse-engineering workflows, turning repeated work into tools, and testing where AI is genuinely useful. Outside the toolchain, I keep learning through games, animation, music, graphics experiments, and public documentation."],traits:[{title:"What I work on",detail:"DCC tools, AI workflows, realtime graphics, games, and animation."},{title:"How I learn",detail:"Build a real workflow, inspect the evidence, then improve the system."},{title:"How I collaborate",detail:"Keep creative decisions human and make repeated production steps dependable."}],linksTitle:"Public channels",linksIntro:"Code, visual work, demos, and ongoing notes live across these profiles.",social:[{name:"GitHub",detail:"Code, tools, and public engineering evidence.",href:"https://github.com/Ubik42",mark:"GH"},{name:"Visual work",detail:"Realtime graphics, materials, shaders, rigging, and procedural work.",href:"#visual-work",mark:"TA"},{name:"Bilibili",detail:"Tool demos, tutorials, and longer videos.",href:"https://space.bilibili.com/12367861?spm_id_from=333.1007.0.0",mark:"Bi"},{name:"Xiaohongshu",detail:"Notes, resources, and everyday discoveries.",href:"https://www.xiaohongshu.com/user/profile/670526b2000000001e001891",mark:"RED"}]},practice:{title:"Experience and education",items:[{period:"2026.03 – 2026.08",title:"AI Tool Technical Artist Intern",place:"Tencent Photon",detail:"Built AI-assisted production tools across DCC, engine, and design workflows, with explicit execution and review boundaries."},{period:"2025.08 – 2027.05",title:"M.S. in EAE, Technical Art",place:"University of Utah",detail:"Studying realtime graphics, tools, pipelines, and collaborative game production in Entertainment Arts and Engineering."},{period:"2020.09 – 2024.06",title:"B.S. in Industrial Engineering",place:"Shanghai Jiao Tong University",detail:"Built a systems and optimization foundation, then applied it through game systems, UE5 client work, and industrial digital twins."}]},footer:{copyright:"Lucas (Yuyan) Shen / 沈裕焱"}},zh:{meta:{title:"沈裕焱 | AI 工具管线 TA & 引擎工具开发",description:"沈裕焱的游戏、DCC 插件、实时图形、引擎工具与 AI 辅助美术管线作品集。"},nav:{work:"作品",practice:"经历",links:"链接",aria:"主导航"},language:{label:"语言",english:"English",changed:"语言已切换为中文。"},hero:{role:"AI 工具管线 TA & 引擎工具开发",primaryAction:"项目作品"},personal:{intro:"作品覆盖游戏、DCC 插件、实时图形、引擎工具与 AI 辅助美术管线，包含运行画面、项目素材和具体实现。",storyAction:"关于我",aboutTitle:"关于我",aboutBody:["我是沈裕焱，一名来自中国的技术美术。我的经历横跨工业工程、游戏开发、实时图形和生产工具，因此我习惯同时理解创作者遇到的问题，以及问题背后的代码与系统。","我喜欢拆解工作流，把重复劳动做成工具，也会认真验证 AI 适合参与哪一步。工具之外，我持续从游戏、动画、音乐、图形实验和公开文档中学习。"],traits:[{title:"我在做什么",detail:"DCC 工具、AI 工作流、实时图形、游戏与动画。"},{title:"我的学习方式",detail:"先做出真实工作流，检查证据，再改进整个系统。"},{title:"我的协作方式",detail:"让创作决定留给人，让重复的生产环节变得可靠。"}],linksTitle:"公开渠道",linksIntro:"代码、视觉作品、演示和持续记录分布在这些公开主页中。",social:[{name:"GitHub",detail:"代码、工具与公开工程证据。",href:"https://github.com/Ubik42",mark:"GH"},{name:"视觉作品",detail:"实时场景、材质、Shader、绑定与程序化内容。",href:"#visual-work",mark:"TA"},{name:"哔哩哔哩",detail:"工具演示、教程和长视频。",href:"https://space.bilibili.com/12367861?spm_id_from=333.1007.0.0",mark:"Bi"},{name:"小红书",detail:"笔记、资源和日常发现。",href:"https://www.xiaohongshu.com/user/profile/670526b2000000001e001891",mark:"RED"}]},practice:{title:"经历与教育",items:[{period:"2026.03 – 2026.08",title:"AI 工具技术美术实习生",place:"腾讯光子",detail:"围绕 DCC、引擎与设计流程开发 AI 辅助美术生产工具，覆盖工具接入、执行边界与人工审查。"},{period:"2025.08 – 2027.05",title:"EAE 技术美术硕士",place:"犹他大学",detail:"在 Entertainment Arts and Engineering 项目中学习实时图形、工具、管线与协作式游戏生产。"},{period:"2020.09 – 2024.06",title:"工业工程学士",place:"上海交通大学",detail:"建立优化与系统方法基础，并逐步扩展到游戏系统、UE5 客户端与工业数字孪生开发。"}]},footer:{copyright:"Lucas (Yuyan) Shen / 沈裕焱"}}},Rv="portfolio.locale.v2";function lC(){try{const a=window.localStorage.getItem(Rv);if(a==="en"||a==="zh")return a}catch{}return"zh"}function cC(a){const r=document.querySelector('meta[name="description"]');r&&(r.content=a)}function uC({children:a}){const[r,o]=J.useState(lC),l=oC[r];J.useEffect(()=>{document.documentElement.lang=r==="zh"?"zh-CN":"en",document.title=l.meta.title,cC(l.meta.description);try{window.localStorage.setItem(Rv,r)}catch{}},[l.meta.description,l.meta.title,r]);const u=J.useMemo(()=>({locale:r,copy:l,setLocale(f){J.startTransition(()=>o(f))}}),[l,r]);return D.jsx(_g,{value:u,children:a})}u1.createRoot(document.getElementById("root")).render(D.jsx(J.StrictMode,{children:D.jsx(uC,{children:D.jsx(sC,{})})}));
//# sourceMappingURL=index-DZMaCdkW-portfolio-refresh.js.map
