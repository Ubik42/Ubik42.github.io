...
`,jp={fathom:{zh:oE,en:lE},"house-of-vampires":{zh:cE,en:uE},"through-other-eyes":{zh:mE,en:hE},"retro-arcade":{zh:dE,en:fE},"digital-twin":{zh:sE,en:rE}},gE=[{id:"noemancer",title:"Noemancer",category:"engine-games",categoryLabel:{zh:"自研游戏引擎",en:"Custom game engine"},summary:{zh:"从原生 Editor、C# Gameplay、资产 Cook 到 D3D12/Vulkan 商业 Raster 和独立 Player 的 C++20 游戏引擎。",en:"A C++20 game engine spanning a native editor, C# gameplay, asset cooking, D3D12/Vulkan commercial raster rendering, and standalone players."},cover:"/media/repositories/major-updates/noemancer-sponza-atrium.webp",tags:["C++20","D3D12 / Vulkan","C#","MCP"],repositoryUrl:"https://github.com/Ubik42/Noemancer",story:{zh:`# Noemancer
...
The Tauri 2 and React desktop application connects to Rez through a Python service, exposes launch diagnostics, and ships a Windows installer plus a documented CLI protocol.`},images:[{src:"/media/repositories/major-updates/rez-overview.png",alt:{zh:"Rez Studio 项目软件库、DCC 版本与插件方案",en:"Rez Studio project library, DCC versions, and plug-in schemes"}},{src:"/media/repositories/major-updates/rez-login.png",alt:{zh:"Rez Studio 本地身份登录与项目入口",en:"Rez Studio local identity and project entry"}}]},{id:"mayascope",title:"MayaScope",category:"pipeline",categoryLabel:{zh:"Maya 场景调查与运行时诊断",en:"Maya scene and runtime observatory"},summary:{zh:"由 MayaIndieTool 演进而来的 Maya 场景调查工具：把大型场景组织成可查询快照、依赖图、运行时足迹和回归证据。",en:"The successor to MayaIndieTool: a Maya scene-investigation workspace built around queryable snapshots, dependency graphs, runtime footprints, and regression evidence."},cover:"/media/repositories/production-tools/mayascope-host.png",tags:["Maya 2025","Scene Graph","Profiler","Regression"],repositoryUrl:"https://github.com/Ubik42/MayaIndieTool",story:{zh:`# MayaScope
...
The direct VST3 path is still experimental and the project is currently distributed as source rather than a packaged end-user release.`},images:[{src:"/media/repositories/neothesia.png",alt:{zh:"Neothesia 钢琴练习界面",en:"Neothesia piano practice interface"}}]},{id:"artflow-agent",title:"ArtFlow Agent",category:"ai-agent",categoryLabel:{zh:"AIGC + Agent",en:"AIGC + Agent"},summary:{zh:"从 UE 场景事实出发，协调本地 ComfyUI 与 GPT Image 2，完成独立评价、有界修订、失败恢复和可验证回流。",en:"Starts from Unreal scene facts and coordinates local ComfyUI and GPT Image 2 for independent judging, bounded revision, recovery, and verified return."},cover:"/media/repositories/major-updates/artflow-delivery.png",tags:["Agent Harness","ComfyUI / GPT Image 2","Unreal 5.8","Evaluation"],repositoryUrl:"https://github.com/Ubik42/ArtFlow-Agent",story:{zh:`# ArtFlow Agent
